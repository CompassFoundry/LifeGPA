    ...
    <div className={styles.container}>
      ...
      <p className={styles.paragraph}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            ...
            visited, and other analytical information.
          </li>
          <li>
      ...
      <p className={styles.paragraph}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            To communicate updates, promotional offers, and respond to
            inquiries.
          </li>
          <li>
      ...
      <p className={styles.paragraph}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            Partners for analytics and marketing, provided appropriate
